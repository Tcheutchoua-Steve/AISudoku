...
def left_diagonal_unit(A, B):
    """ Create a list for the diagonal unit
    Args:
        A: the row  name of the square
    Returns:
        A,B : list representing the value keys to the grid
    """
    left_diag = []
    i = 0
